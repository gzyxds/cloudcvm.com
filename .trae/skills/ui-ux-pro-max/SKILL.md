---
name: ui-ux-pro-max
description: "UI/UX design intelligence for web and mobile. Invoke when designing pages, components, layouts, colors, typography, animations, or reviewing UI code. Covers accessibility, interaction patterns, responsive design, and visual consistency across React, Next.js, Vue, Tailwind, and shadcn/ui."
---
...
|------|----------|--------|----------------|
| **No Emoji as Structural Icons** | Use vector-based icons (e.g., Lucide, Heroicons). | Using emojis for navigation, settings, or system controls. | Emojis are font-dependent, inconsistent across platforms, and cannot be controlled via design tokens. |
