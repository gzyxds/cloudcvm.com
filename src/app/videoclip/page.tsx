...
export const metadata: Metadata = {
  title: { absolute: '视频混剪助手 - 开源免费的视频剪辑软件 | 必定AI-BuidAI' },
  description: '必定AI-BuidAI 视频混剪助手是一款高效易用的视频剪辑软件,专为短视频创作者、Vlogger及营销人员设计。支持自动化批量剪辑、智能转场、滤镜调色、字幕添加和背景音乐匹配,提供海量模板与素材库,一键生成节奏感强、视觉冲击力大的混剪视频。基于开源技术构建,提供完整源码与私有化部署支持。',
  keywords: '视频混剪,视频剪辑,批量剪辑,智能转场,滤镜调色,字幕添加,背景音乐,必定AI,BuidAI,视频制作工具,开源AI系统,私有化部署,视频剪辑源码',
  openGraph: { title: '视频混剪助手 - 一键生成混剪视频 | 必定AI-BuidAI', description: '高效易用的视频剪辑软件,支持自动化批量剪辑、智能转场、滤镜调色、字幕添加和背景音乐匹配。一键生成节奏感强、视觉冲击力大的混剪视频。', images: ['/product/videoclip.png'], type: 'website' },
  twitter: { card: 'summary_large_image', title: '视频混剪助手 - 一键生成混剪视频 | 必定AI-BuidAI', description: '高效易用的视频剪辑软件,支持自动化批量剪辑、智能转场、滤镜调色、字幕添加和背景音乐匹配,大幅降低剪辑门槛与时间成本。', images: ['/product/videoclip.png'] },
}
...
export default function VideoclipPage() {
  return (<><Header /><main><BananaProductPage
    ...
    heroImage="/images/aisolution/videoclip-2.png"
    featuresTitle=""
