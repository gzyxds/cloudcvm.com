...
export const metadata: Metadata = {
  ...
  description:
    '智言AI 视频混剪助手是一款高效易用的视频剪辑软件,专为短视频创作者、Vlogger及营销人员设计。支持自动化批量剪辑、智能转场、滤镜调色、字幕添加和背景音乐匹配,提供海量模板与素材库,一键生成节奏感强、视觉冲击力大的混剪视频。基于开源技术构建,提供完整源码与私有化部署支持。',
  keywords:
    '视频混剪,视频剪辑,批量剪辑,智能转场,滤镜调色,字幕添加,背景音乐,必定AI,智言AI,视频制作工具,开源AI系统,私有化部署,视频剪辑源码',
  openGraph: {
    title: '视频混剪助手 - 一键生成混剪视频 | 智言AI',
    description:
      '高效易用的视频剪辑软件,支持自动化批量剪辑、智能转场、滤镜调色、字幕添加和背景音乐匹配。一键生成节奏感强、视觉冲击力大的混剪视频。',
    images: ['/product/videoclip.webp'],
    type: 'website',
  },
  twitter: {
    ...
    <>
      ...
      <main>
        <BananaProductPage
          ...
          heroDesc={
            <>
              高效易用的视频剪辑软件,支持自动化批量剪辑、智能转场、滤镜调色、字幕添加和背景音乐匹配。
              <br className="hidden sm:block" />
              一键生成节奏感强、视觉冲击力大的混剪视频,大幅降低剪辑门槛与时间成本。
            </>
          }
          heroImage="/images/product/热门视频混剪.webp"
          featuresTitle=""
          ...
          featureDetails={[
            {
              ...
              image: '/images/product/热门视频混剪.webp',
            },
            {
              title: '智能转场,流畅自然',
