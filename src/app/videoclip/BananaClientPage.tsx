      ...
      <Container>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
          <div className="flex items-center gap-2 text-xl font-bold text-gray-400">
            <FilmIcon className="w-6 h-6" /> Premiere
          </div>
          <div className="flex items-center gap-2 text-xl font-bold text-gray-400">
            <AdjustmentsHorizontalIcon className="w-6 h-6" /> Final Cut
          </div>
          <div className="flex items-center gap-2 text-xl font-bold text-gray-400">
            <SparklesIcon className="w-6 h-6" /> CapCut
          </div>
          <div className="flex items-center gap-2 text-xl font-bold text-gray-400">
            <RectangleStackIcon className="w-6 h-6" /> 剪映
          </div>
        </div>
      </Container>
    </div>
...
function LandingUserReviews() {
  const reviews = [
    {
      content: '批量剪辑功能非常实用，大幅提升了我们的视频制作效率，节省了大量时间成本。',
      author: '张剪辑师',
      role: '视频剪辑总监',
    },
    {
      content: '智能转场和滤镜调色功能很强大，让视频衔接更加流畅自然，视觉效果专业。',
      author: '李创作',
      role: '内容创作经理',
    },
    {
      content: '海量模板与素材库很丰富，一键套用模板，快速生成专业级视频，降低剪辑门槛。',
      author: '王运营',
      role: '运营总监',
    },
  ]
