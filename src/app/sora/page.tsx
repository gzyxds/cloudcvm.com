...
export const metadata: Metadata = {
  ...
  description:
    '智言AI Sora 视频生成平台提供一站式 AI 视频创作解决方案。支持高质量文生视频、图生视频及长视频生成。基于开源 Sora 技术构建，提供 Sora 源码与私有化部署支持，助力企业低成本打造专属 AI 视频应用。',
  keywords:
    'Sora,Sora视频,Sora源码,AI视频生成,文生视频,视频生成模型,智言AI,开源AI系统,私有化部署,OpenAI Sora,视频大模型',
  openGraph: {
    title: 'Sora 视频生成引擎 - 打造您的专属 AI 视频创作平台 | 智言AI',
    description:
      '一键生成电影级 AI 视频，支持文生视频与图生视频。基于开源 Sora 技术构建的新一代 AI 视频生成平台，提供完整源码，让创意无限延伸。',
    images: ['/product/sora.webp'],
    type: 'website',
  },
  twitter: {
      ...
      <main>
        <BananaProductPage
          ...
          features={[
            ...
            {
              title: 'Sora 工作流自动化',
              desc: '与 智言AI 工作流引擎深度集成，从脚本生成到多端分发全流程自动化。',
              icon: 'CommandLine',
            },
            {
              title: '企业级 Sora 部署',
          ...
          featureDetails={[
            {
              ...
              image: '/images/aisolution/sora-1.webp',
            },
            {
              ...
              image: '/images/aisolution/sora-2.webp',
            },
            {
              ...
              points: [
                ...
                {
                  title: '配音与字幕一体化',
                  desc: '与 智言AI 语音、字幕能力集成，一键生成多语种配音与字幕轨道，降低后期成本。',
                },
                {
                  title: '多渠道发布适配',
              ...
              image: '/images/aisolution/sora-3.webp',
            },
          ]}
          ctaTitle="准备好开始创作了吗？"
