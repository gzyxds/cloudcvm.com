...
export const metadata: Metadata = {
  title: { absolute: 'AI音乐 - 开源免费的 AI 音乐生成系统 | 必定AI-BuidAI' },
  description: '必定AI-BuidAI AI音乐是一款以文本/歌词/哼唱/乐谱为输入,快速生成完整歌曲、伴奏、人声或纯音乐的创作与生产工具,旨在降低门槛、提升效率,支持个人娱乐与商用配乐的&ldquo;人机协同&rdquo;。基于开源技术构建,提供完整源码与私有化部署支持。',
  keywords: 'AI音乐,音乐生成,文生音乐,歌词生成,哼唱生成,乐谱生成,必定AI,BuidAI,音乐创作工具,开源AI系统,私有化部署,音乐源码',
  openGraph: { title: 'AI音乐 - 一键生成 AI 音乐 | 必定AI-BuidAI', description: '以文本/歌词/哼唱/乐谱为输入,快速生成完整歌曲、伴奏、人声或纯音乐。降低门槛、提升效率,支持个人娱乐与商用配乐。', images: ['/product/music.png'], type: 'website' },
  twitter: { card: 'summary_large_image', title: 'AI音乐 - 一键生成 AI 音乐 | 必定AI-BuidAI', description: '以文本/歌词/哼唱/乐谱为输入,快速生成完整歌曲、伴奏、人声或纯音乐,降低门槛、提升效率。', images: ['/product/music.png'] },
}
...
export default function MusicPage() {
  return (<><Header /><main><BananaProductPage
    ...
    heroImage="/images/aisolution/music-1.png"
    featuresTitle=""
    ...
    featureDetails={[
      ...
      { title: '多种输出,满足不同场景', desc: '支持生成完整歌曲、伴奏、人声或纯音乐,满足个人娱乐与商用配乐的不同需求。提供完整的商用授权支持。', activePoint: 0, points: [{ title: '完整歌曲', desc: '支持生成完整歌曲,包含人声和伴奏,满足个人娱乐需求。' }, { title: '伴奏输出', desc: '支持生成纯伴奏音乐,方便用户添加自己的人声或进行二次创作。' }, { title: '人声输出', desc: '支持生成纯人声,方便用户进行混音和后期处理。' }, { title: '商用授权', desc: '提供完整的商用授权支持,支持个人娱乐与商用配乐,满足商业需求。' }], image: '/images/aisolution/music-3.png' },
    ]}
    ctaTitle="准备好开始创作了吗？"
