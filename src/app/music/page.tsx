...
export const metadata: Metadata = {
  ...
  description:
    '智言AI AI音乐是一款以文本/歌词/哼唱/乐谱为输入,快速生成完整歌曲、伴奏、人声或纯音乐的创作与生产工具,旨在降低门槛、提升效率,支持个人娱乐与商用配乐的&ldquo;人机协同&rdquo;。基于开源技术构建,提供完整源码与私有化部署支持。',
  keywords:
    'AI音乐,音乐生成,文生音乐,歌词生成,哼唱生成,乐谱生成,必定AI,智言AI,音乐创作工具,开源AI系统,私有化部署,音乐源码',
  openGraph: {
    title: 'AI音乐 - 一键生成 AI 音乐 | 智言AI',
    description:
      '以文本/歌词/哼唱/乐谱为输入,快速生成完整歌曲、伴奏、人声或纯音乐。降低门槛、提升效率,支持个人娱乐与商用配乐。',
    images: ['/product/music.webp'],
    type: 'website',
  },
  twitter: {
        ...
        <BananaProductPage
          ...
          heroDesc={
            <>
              ...
              降低门槛、提升效率,支持个人娱乐与商用配乐的&ldquo;人机协同&rdquo;。
            </>
          }
          ...
          featureDetails={[
            {
              ...
              image: '/images/aisolution/music-1.webp',
            },
            {
              title: '哼唱生成,旋律即刻成曲',
              ...
              image: '/images/aisolution/music-2.webp',
            },
            {
              title: '多种输出,满足不同场景',
              ...
              image: '/images/aisolution/music-3.webp',
            },
          ]}
          ctaTitle="准备好开始创作了吗？"
