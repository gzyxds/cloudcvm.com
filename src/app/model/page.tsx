...
export const metadata: Metadata = {
  title: { absolute: '电商试衣换装 - 开源免费的AI模特换装系统 | 必定AI-BuidAI' },
  ...
  openGraph: { title: '电商试衣换装 - AI模特多场景切换 | 必定AI-BuidAI', description: '专为电商卖家打造的AI视觉优化解决方案，提升商品主图的吸引力与转化率。无需复杂拍摄与高昂成本，通过AI技术实现商品一键适配模特上身与背景智能替换。', images: ['/product/model.png'], type: 'website' },
  twitter: { card: 'summary_large_image', title: '电商试衣换装 - AI模特多场景切换 | 必定AI-BuidAI', description: '专为电商卖家打造的AI视觉优化解决方案，提升商品主图的吸引力与转化率。无需复杂拍摄与高昂成本，通过AI技术实现商品一键适配模特上身与背景智能替换。', images: ['/product/model.png'] },
}
...
export default function ModelPage() {
  return (<><Header /><main><BananaProductPage
    ...
    heroImage="/images/aisolution/model-4.png"
    featuresTitle=""
