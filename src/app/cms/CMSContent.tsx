          ...
          <div className="space-y-8">
            ...
            >
              <Button
                ...
                variant="erlieSolid"
                color="blue"
                className="group w-full rounded-xl px-8 py-3.5 text-base font-medium sm:w-auto"
              >
                <span>立即体验</span>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="rounded-xl bg-gradient-to-r from-green-500 to-green-600 p-3 text-center shadow-md transition-all hover:shadow-lg">
                      <div className="text-xs font-medium text-white/90">转化率</div>
                      <div className="mt-1 text-lg font-bold text-white">12.5%</div>
                    </div>
                  </div>
...
export default function CMSContent() {
  return (
    <>
      <Header />
      <main className="bg-white pt-10 sm:pt-0">
        <CMSHeroSection />
        <SectionNav />
        <CMSFeaturesSection />
        <CMSScenariosSection />
