...
export const metadata: Metadata = {
  ...
  description:
    '智言AI 即梦AI是一款快速生成视频的工具,用户只需输入文字描述或上传参考图,即可快速生成风格多样的短视频。支持纯文本提示词或上传参考图来生成视频,支持生成不同的视频比例、分辨率(720P、1080P)。基于开源技术构建,提供完整源码与私有化部署支持。',
  keywords:
    '即梦AI,AI视频生成,文生视频,图生视频,视频生成工具,必定AI,智言AI,视频制作,开源AI系统,私有化部署,即梦4.0,视频生成源码',
  openGraph: {
    ...
    <>
      ...
      <main>
        <BananaProductPage
          ...
          heroDesc={
            <>
              新一代 AI 视频生成工具，输入文字描述或上传参考图即可快速生成视频。
              <br className="hidden sm:block" />
              支持多种视频比例和分辨率，让创作更简单，开启智能视频创作新时代。
            </>
          }
          ...
          features={[
            {
              title: '文生视频',
              desc: '支持纯文本提示词来生成视频，用户只需输入文字描述，即可快速生成风格多样的短视频。',
              icon: 'DocumentText',
            },
            {
              title: '图生视频',
              desc: '支持上传参考图来生成视频，并可进行多张图片融合，让创作更加灵活多样。',
              icon: 'Photo',
            },
            {
              title: '多种分辨率',
              desc: '支持生成不同的视频比例和分辨率，包括 720P、1080P 等，满足不同场景需求。',
              icon: 'Film',
            },
            {
              title: '视频下载',
              desc: '生成的视频支持一键下载，方便用户保存和分享到各大平台。',
              icon: 'ArrowDownTray',
            },
            {
              title: '提示词示例',
            ...
            {
              title: '灵感广场',
              desc: '后台可配置灵感广场示例视频，为用户提供创作灵感和参考。',
              icon: 'Sparkles',
            },
          ]}
          featureDetails={[
            ...
            },
            {
              ...
              points: [
                {
                  title: '多图参考输入',
                  desc: '支持上传多张参考图来生成视频，提供更丰富的创作素材和灵感来源。',
                },
                {
                  title: '智能图片融合',
            ...
            },
            {
              ...
              points: [
                ...
                {
                  title: '灵感广场示例',
                  desc: '后台可配置灵感广场示例视频，为用户提供创作灵感和参考，激发创意灵感。',
                },
                {
                  title: '生成记录与积分管理',
