...
export const metadata: Metadata = {
  ...
  keywords:
    'Nanobanana,香蕉绘画,AI绘画,文生图,图生图,多图融合,Gemini 3 Pro,图像生成模型,智言AI,开源AI系统,私有化部署,AI绘画工具',
  openGraph: {
    ...
    <>
      ...
      <main>
        <BananaProductPage
          ...
          heroDesc={
            <>
              基于 Gemini 3 Pro Image Preview 的新一代 AI 绘画平台,一键生成高质量图像。
              <br className="hidden sm:block" />
              预置模板开箱即用,保持角色一致性,开启智能绘画创作新时代。
            </>
          }
