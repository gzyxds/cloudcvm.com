...
const SolutionCard = memo(function SolutionCard({ item }: SolutionCardProps) {
  ...
  const cardContent = (
    <>
      ...
      {/* 内容 — 浮在遮罩上方 */}
      <div className="relative z-10 flex aspect-[16/9] flex-col justify-end p-4 sm:aspect-[3/4] sm:p-5 lg:aspect-[9/16] lg:p-6">
        {/* 图标 */}
        <div
          className={clsx(
        ...
        {/* 标题 */}
        <h3 className="mb-2 text-base leading-tight font-bold text-white drop-shadow-md sm:text-lg lg:text-xl">
          {item.title}
        </h3>

        {/* 描述 */}
        <p className="mb-3 line-clamp-2 text-[13px] leading-relaxed text-white/85 sm:mb-4 sm:line-clamp-3 sm:text-sm">
          {item.description}
        </p>
  ...
  return (
    ...
    >
      <Container className="relative z-10">
              ...
              >
                ...
                <span
                  className={clsx(
                    ...
                    activeTab === category.id ? 'bg-brand-100 text-brand-500' : 'text-neutral-400'
                  )}
                  aria-hidden="true"
                >
        ...
        <div className="scrollbar-hide overflow-x-auto sm:overflow-visible">
          <div
