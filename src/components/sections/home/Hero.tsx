...
function CloudVisualization() {
  ...
  return (
    <div
      className="relative min-h-[320px] w-full sm:min-h-[440px] lg:min-h-[380px] xl:min-h-[440px] 2xl:min-h-[520px]"
      aria-hidden="true"
    >
      {/* 固定尺寸 + scale 等比缩放，flex 居中 */}
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
        <div className="origin-center scale-[0.58] sm:scale-75 lg:scale-[0.6] xl:scale-[0.75] 2xl:scale-90">
