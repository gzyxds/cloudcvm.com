...
function SolutionCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          'pointer-events-none absolute inset-0 bg-gradient-to-b from-white to-brand-50 transition-opacity duration-300',
      ...
      <div className="relative z-10 flex h-full flex-col p-6">
        ...
        <div className="mb-12 flex items-center justify-between">
          <h3 className="py-2 font-display text-xl font-bold tracking-tight text-white drop-shadow-md">
            {solution.title}
          </h3>
          ...
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-full border border-white/30 bg-white/20 backdrop-blur-sm transition-all duration-200 group-hover:border-brand-500 group-hover:bg-brand-500 group-hover:text-white">
        ...
        >
          ...
          <div className="space-y-3">
            <h4 className="mb-3 text-base font-semibold text-white drop-shadow-md">核心功能</h4>
  ...
  return (
    ...
    >
      <Container className="relative">
        ...
        {/* 移动端横排滑动布局 - 隐藏在PC端 */}
        <div className="scrollbar-hide flex touch-pan-x snap-x snap-mandatory gap-3 overflow-x-auto pb-2 lg:hidden">
          {solutions.map((solution, index) => (
            <MobileSolutionCard key={index} solution={solution} />
          ))}
        </div>
      </Container>
    </section>
