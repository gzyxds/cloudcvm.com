  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-lg bg-[#eff6ff] transition-colors duration-200 group-hover:bg-[#0055ff]">
        <Icon
          className="h-5 w-5 text-[#0055ff] transition-colors duration-200 group-hover:text-white"
          strokeWidth={1.5}
        />
      </div>
      ...
      <div className="mt-5 flex items-center justify-between border-t border-[#E2E8F0] pt-4">
        <div className="flex items-baseline gap-1.5">
          <span className="text-lg font-bold text-[#0F172A] tabular-nums">{item.stat}</span>
          <span className="text-xs text-[#64748B]">{item.statLabel}</span>
        </div>
        <ArrowRight
          className="h-4 w-4 text-[#94A3B8] transition-all duration-200 group-hover:translate-x-0.5 group-hover:text-[#0055ff]"
          strokeWidth={1.5}
        />
      </div>
    </motion.a>
