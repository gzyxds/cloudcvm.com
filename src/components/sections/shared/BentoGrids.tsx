      ...
      <div className="relative flex h-full flex-col p-6">
        ...
        <div className="mb-12 flex items-center justify-between">
          <h3
            className={clsx(
              ...
              isExpanded ? 'text-brand-500' : 'text-neutral-900'
            )}
          >
            {feature.title}
          </h3>
        ...
        <div className="flex-1 transition-all delay-100 duration-500">
          ...
          <div className="space-y-3">
            <h4 className="mb-3 text-base font-semibold text-neutral-900">核心功能</h4>
            {feature.features.map((featureItem, featureIndex) => (
              <div key={featureIndex} className="flex items-center text-base text-neutral-500">
    ...
    <div className="xs:h-[220px] group relative h-[180px] overflow-hidden rounded-md border border-neutral-200 bg-white/80 backdrop-blur-md transition-all hover:shadow-lg hover:shadow-slate-200/50 sm:h-[280px]">
      ...
      <div className="relative flex h-full flex-col p-3 sm:p-4">
        ...
        <div className="mb-2 flex items-center justify-between sm:mb-3">
          <h3 className="text-base font-bold text-neutral-900 sm:text-lg">{feature.title}</h3>
        ...
        <div className="space-y-1 sm:space-y-2">
          <h4 className="text-xs font-semibold text-neutral-900 sm:text-sm">核心功能</h4>
