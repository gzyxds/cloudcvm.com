 ...
 * @property {React.ComponentType<React.SVGProps<SVGSVGElement>>} icon - Heroicons 图标组件
  ...
  return (
    <div className="group flex h-full transform flex-col overflow-hidden rounded-md border border-gray-100 bg-white transition-all duration-300 hover:-translate-y-1 dark:border-gray-700 dark:bg-gray-800">
      <div className="p-5">
        ...
        >
          <span className="transition-all duration-300 group-hover:mr-1">查看详情</span>
...
/**
 * AiSolutionSection 组件 - 艺创AI企业解决方案展示区域
 * 参考原 Aisd.astro 设计（该文件已随项目迁移移除），展示企业AI解决方案
 ...
 * 6. 悬停交互效果
 * 7. 服务特点展示区域
 * @returns {JSX.Element} AiSolutionSection 组件
 */
