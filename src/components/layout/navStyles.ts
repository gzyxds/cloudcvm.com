...
export const featuredCardIcon = 'flex h-6 w-6 shrink-0 items-center justify-center text-brand-500'
export const productLink =
  'group/link block rounded-md px-3 py-2 transition-colors hover:bg-neutral-50'
export const productLinkIcon = 'flex h-5 w-5 shrink-0 items-center justify-center text-brand-500'
