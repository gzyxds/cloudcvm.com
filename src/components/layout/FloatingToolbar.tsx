                  ...
                  >
                    <div className="p-5">
                      <div className="text-center">
                        <div className="mb-4 text-sm text-gray-600">扫码联系客服</div>
                  ...
                  >
                    <div className="p-6">
                      <div className="text-left">
                        <div className="mb-4 text-sm font-semibold text-gray-800">优刻云</div>
                        <div className="space-y-3">
                          ...
                          <div className="my-3 border-t border-gray-200/70 pt-3">
                            <div className="mb-1 text-xs font-medium text-gray-700">Telegram</div>

                            <Link
                              href="https://t.me/Youkeyun"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-xs text-blue-600 transition-colors duration-200 hover:text-blue-700 hover:underline"
                            >
                              @Youkeyun
                            </Link>
                          </div>
                          <div className="my-3 border-t border-gray-200/70 pt-3 text-center">
                            <div className="mb-3 text-xs font-medium text-gray-700">腾讯客服</div>
                            <div className="flex justify-center">
                              <Image
                                ...
                                width={110}
                                height={110}
                                className="rounded-md border border-gray-200 shadow-sm transition-all duration-300 hover:shadow-md"
                              />
                            </div>
                          </div>
                        </div>
              ...
              <AnimatePresence>
                {showShoppingCart && (
                  ...
                  >
                    <div className="p-6">
                      <div className="text-center">
                        <div className="mb-3 text-sm font-semibold text-gray-800">购物车</div>
                        <div className="text-xs text-gray-600">查看您的购物车商品</div>
                      </div>
                    </div>
          ...
          >
            ...
            >
              ...
              <div className="p-8 text-center">
                <h3 className="mb-2 text-lg font-semibold text-gray-900">联系客服</h3>
                <p className="mb-6 text-sm text-gray-600">扫描二维码添加客服微信</p>
