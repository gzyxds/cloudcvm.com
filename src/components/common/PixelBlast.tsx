...
interface PixelBlastProps {
  /** 像素图案变体类型 */
  variant?: 'diamond' | 'square' | 'circle' | 'triangle'
  /** 像素大小 */
  pixelSize?: number
  /** 主色调 */
  color?: string
...
export default function PixelBlast({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      if (t.liquidEffect) {
        ...
        const freqUniform = liqEffect.uniforms.get('uFreq')
  ...
  }, [variant, pixelSize, color, patternScale, patternDensity, pixelSizeJitter, enableRipples, rippleSpeed, rippleThickness, rippleIntensityScale, liquid, liquidStrength, liquidRadius, liquidWobbleSpeed, speed, transparent, edgeFade, noiseAmount])
