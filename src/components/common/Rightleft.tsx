    ...
    <section className="relative bg-cover bg-center bg-no-repeat py-12 sm:py-16 lg:py-24" style={{ backgroundImage: 'url("/images/background/background-5.webp")' }}>
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          {/* 左侧卡片：极速体验模型 */}
          <div className="flex flex-col overflow-hidden rounded-md bg-white border border-[#E2E8F0] shadow-sm transition-all duration-300 hover:shadow-lg hover:shadow-slate-200/50">
