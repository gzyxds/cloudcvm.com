...
const defaultSlides: CarouselSlide[] = [
  {
    ...
    videoPath: 'http://dogecloud.cloudcvm.com/VideoCarousel.mp4',
    imageAlt: '全方位支付解决方案',
  ...
  },
  {
    ...
    videoPath: 'http://dogecloud.cloudcvm.com/VideoCarousel1.mp4',
    imageAlt: '云计算解决方案',
  ...
  },
  {
    ...
    videoPath: 'http://dogecloud.cloudcvm.com/VideoCarousel2.mp4',
    imageAlt: 'GPU云服务器平台',
    primaryButtonText: '立即查看',
    primaryButtonHref: 'https://console.cloudcvm.com/cart/goodsList.htm',
    secondaryButtonText: '立即购买',
  ...
  },
  {
    ...
    videoPath: 'http://dogecloud.cloudcvm.com/VideoCarousel3.mp4',
    imageAlt: '全球化部署解决方案',
    primaryButtonText: '立即查看',
    primaryButtonHref: 'https://console.cloudcvm.com/cart/goodsList.htm',
    secondaryButtonText: '立即购买',
