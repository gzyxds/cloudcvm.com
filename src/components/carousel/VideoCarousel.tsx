...
const defaultSlides: CarouselSlide[] = [
  {
    ...
    videoPath: '/videos/VideoCarousel.mp4',
    imageAlt: '全方位支付解决方案',
  ...
  },
  {
    ...
    videoPath: '/videos/VideoCarousel1.mp4',
    imageAlt: '云计算解决方案',
  ...
  },
  {
    ...
    videoPath: '/videos/VideoCarousel2.mp4',
    imageAlt: 'GPU云服务器平台',
    primaryButtonText: '立即查看',
    primaryButtonHref: 'https://console.cloudcvm.com/cart/goodsList.htm',
    secondaryButtonText: '立即购买',
  ...
  },
  {
    ...
    videoPath: '/videos/VideoCarousel3.mp4',
    imageAlt: '全球化部署解决方案',
    primaryButtonText: '立即查看',
    primaryButtonHref: 'https://console.cloudcvm.com/cart/goodsList.htm',
    secondaryButtonText: '立即购买',
...
const CarouselImage = memo(
  ({
    ...
    return (
      <div
        className={`${styles.imageContainer} ${isActive ? 'z-10 opacity-100' : 'z-0 opacity-0'}`}
      >
    ...
    <div className="relative">
      ...
      >
        ...
        <div
          ...
          aria-live="off"
        >
          <Container className="flex w-full flex-col px-0 sm:px-2 lg:flex-row lg:px-4">
            {/* 左侧标题列表 - 移动端隐藏，PC端显示 */}
            ...
            <div className="flex max-w-4xl flex-1 flex-col justify-center gap-5 px-0 py-6 sm:py-8 lg:ml-12 lg:py-0 2xl:ml-16 2xl:max-w-5xl">
              ...
              {/* 普通链接按钮 - Bento 风格 */}
              <div className="flex w-full flex-row justify-between gap-3 pt-1 sm:w-auto sm:justify-start sm:gap-4">
                <a
      ...
      <div className="absolute right-0 bottom-0 left-0 z-20 translate-y-1/2 transform">
        {/* PC端：四栏布局，页面标准间距均匀分布 */}
        <div className="hidden border-y border-[#eee] bg-white lg:block">
          <Container>
